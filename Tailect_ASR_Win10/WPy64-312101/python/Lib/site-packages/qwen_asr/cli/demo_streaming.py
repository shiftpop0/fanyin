...
"""
Minimal web demo for Tailect ASR streaming inference.

Install:
  Ensure the vLLM dependencies are available in this environment.

Run:
  python -m tailect_asr.cli.demo_streaming
Open:
  http://127.0.0.1:7860
"""
import argparse
...
<head>
  ...
  <title>Tailect ASR Streaming</title>
  <style>
    :root{
      --bg:#ffffff;
      --card:#ffffff;
