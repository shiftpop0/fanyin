...
(function () {
  ...
  const DEFAULT_CONFIG = {
    modelBaseUrl: 'http://100.100.80.117:7867',
...
`;
  ...
  function locateRecordSource(key) {
    ...
    element.classList.add('tm-source-highlight');
    setTimeout(() => {
      try { element.classList.remove('tm-source-highlight'); } catch (_) {}
    }, 2200);
  }
