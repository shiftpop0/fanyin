...
if not exist "%PAYLOAD%\tailect_webui_start.bat" (
...
copy /Y "%PAYLOAD%\demo.py" "%TARGET_ROOT%\Tailect_ASR_Win10\WPy64-312101\python\Lib\site-packages\qwen_asr\cli\demo.py" >nul
if errorlevel 1 goto copy_failed

echo [3/5] 更新 WebUI 启动脚本...
copy /Y "%PAYLOAD%\tailect_webui_start.bat" "%TARGET_ROOT%\Tailect_ASR_Win10\一键启动WebUI.bat" >nul
if errorlevel 1 goto copy_failed

echo [4/5] 更新油猴脚本文件...
copy /Y "%PAYLOAD%\spyware-translator.user.js" "%TARGET_ROOT%\spyware-translator\spyware-translator.user.js" >nul
if errorlevel 1 goto copy_failed
